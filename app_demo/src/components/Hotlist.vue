        ...
        <div class="recommend-list-block">
          ...
          <div class="recommend-list">
            ...
            <div class="recommend-list-li" v-for="item in list" :key="item.id">
              ...
              <div class="recommend-centre-block" @click="clickcentre(item.id)">
                <div class="recommend-centre">
                  {{item.name}}
                </div>
                <!-- 丹徒 -->
                <div class="recommend-centre-img" v-if="item.type == 2">
                  <van-image class="recommendall-li-img" fit="cover" :src="item.image" />
                </div>

                <!-- 多图 -->
                <div class="recommend-all-img" v-if="item.type == 1 && item.imgcount != 4">
                  <div class="recommend-all-li" v-for="(value, name) in item.listimage">
                    <van-image class="all-li-img" fit="cover" :src="value" />
                    <div class="recommend-all-mumber" v-if="item.imgjiu == 1">
  ...
  export default {
    ...
    methods:{
      ...
      get_list(p,type){
        ...
        // }
        this.$axios
             .post(this.$myStore.url+"/api/index/get_article",this.$qs.stringify({p:p,token:token,type:2,id:-1}))
             .then(response=>{
...
<style>
  ...
  .recommend-centre-img .recommendall-li-img{
    width: 680px;
    height: 300px;
  }
